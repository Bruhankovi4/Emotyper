...
{
    public partial class DiagramFormOutput : QDockingWindow
    {
        public DiagramFormOutput()
        {
            InitializeComponent();
        ...
        private void LoadBlockOutputs()
        {
            ...
            {
                ShowOutputList.Enabled = true;
                ShowOutputLabel.Enabled = true;
            }
            else
            {
                ShowOutputList.Enabled = false;
                ShowOutputLabel.Enabled = false;
                ShowOutputSignal.Enabled = false;
            }
        }
