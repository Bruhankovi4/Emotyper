	...
	public partial class OnlineOfflineLegend : IDisposable
	{
			...
			string description5Header = "Desc. 5")
		{
			...
			TableLegend = new TableLegend(
				...
				description4Header,
				description5Header);
			offlineLegendHolder.Content = TableLegend;

			TileLegend = new TileLegend(curveDisplay);
			onlineLegendHolder.Content = TileLegend;
		...
		public TableLegend TableLegend { get; private set; }
		public TileLegend TileLegend { get; private set; }
